...
def __getJoueurs(fichier : str)->list[joueur]:
    ...
    datas : list[str]
    errorInPlayerData : bool

    errorInPlayerData = False
    ...
    if(errorInPlayerData):
        os.system("cls")
        print(R + "Il y a des erreurs dans le fichiers des joueurs" + W)
        print(R + "Seules les lignes correctes ont été utilisées" + W)
        os.system("pause")
    f.close()
...
def __afficher_profils(j1_name : str, j2_name : str, nb_humans : int, listJoueurs : list[joueur], difficulty : list[int]):
    ...
    if(nb_humans == 2):
        ...
        if(j1.getGameDevinette() == 0 and j2.getGameDevinette() == 0):
            print("Devinettes :  " + G + str(j1.getScoreDevinette()) + W + "/" + R + str(j1.getGameDevinette() - j1.getScoreDevinette()) + " " + O + "--%" + W + (21 - (len(str(j1.getScoreDevinette()) + "/" + str(j1.getGameDevinette() - j1.getScoreDevinette()) + " --%"))) * " " + "|  " + "Devinettes :  " + G + str(j2.getScoreDevinette()) +  W + "/" + R + str(j2.getGameDevinette() - j2.getScoreDevinette()) + O + " --%" + W)
        elif(j1.getGameDevinette() == 0):
            print("Devinettes :  " + G + str(j1.getScoreDevinette()) + W + "/" + R + str(j1.getGameDevinette() - j1.getScoreDevinette()) + " " + O + "--%" + W +  (21 - (len(str(j1.getScoreDevinette()) + "/" + str(j1.getGameDevinette() - j1.getScoreDevinette()) + " --%"))) * " " + "|  " + "Devinettes :  " + G + str(j2.getScoreDevinette()) + W +  "/" + R + str(j2.getGameDevinette() - j2.getScoreDevinette()) + O + " " + str(round((j2.getScoreDevinette()/j2.getGameDevinette()) * 100)) + "%" + W)
        elif(j2.getGameDevinette() == 0):
            print("Devinettes :  " + G + str(j1.getScoreDevinette()) + W + "/" + R + str(j1.getGameDevinette() - j1.getScoreDevinette()) + " " + O + str(round((j1.getScoreDevinette()/j1.getGameDevinette()) * 100)) + "%"  + W + (21 - (len(str(j1.getScoreDevinette()) + "/" + str(j1.getGameDevinette() - j1.getScoreDevinette()) + " " + str(round((j1.getScoreDevinette()/j1.getGameDevinette()) * 100)) + "%"))) * " " + "|  " + "Devinettes :  " + G + str(j2.getScoreDevinette()) + "/" + R + str(j2.getGameDevinette() - j2.getScoreDevinette()) + O + " --%" + W)
        else:
        ...
        if(j1.getGameAllumettes() == 0 and j2.getGameAllumettes() == 0):
            print("Allumettes :  " + G + str(j1.getScoreAllumettes()) + W + "/" + R + str(j1.getGameAllumettes() - j1.getScoreAllumettes()) + " " + O + "--%" + W + (21 - (len(str(j1.getScoreAllumettes()) + "/" + str(j1.getGameAllumettes() - j1.getScoreAllumettes()) + " --%"))) * " " + "|  " + "Allumettes :  " + G + str(j2.getScoreAllumettes()) + W +  "/" + R + str(j2.getGameAllumettes() - j2.getScoreAllumettes()) + O + " --%" + W)
        elif(j1.getGameAllumettes() == 0):
            print("Allumettes :  " + G + str(j1.getScoreAllumettes()) + W + "/" + R + str(j1.getGameAllumettes() - j1.getScoreAllumettes()) + " " + O + "--%" + W + (21 - (len(str(j1.getScoreAllumettes()) + "/" + str(j1.getGameAllumettes() - j1.getScoreAllumettes()) + " --%"))) * " " + "|  " + "Allumettes :  " + G + str(j2.getScoreAllumettes()) + W +  "/" + R + str(j2.getGameAllumettes() - j2.getScoreAllumettes()) + O + " " + str(round((j2.getScoreAllumettes()/j2.getGameAllumettes()) * 100)) + "%" + W)
        elif(j2.getGameAllumettes() == 0):
            print("Allumettes :  " + G + str(j1.getScoreAllumettes()) + W + "/" + R + str(j1.getGameAllumettes() - j1.getScoreAllumettes()) + " " + O + str(round((j1.getScoreAllumettes()/j1.getGameAllumettes()) * 100)) + "%"  + W + (21 - (len(str(j1.getScoreAllumettes()) + "/" + str(j1.getGameAllumettes() - j1.getScoreAllumettes()) + " " + str(round((j1.getScoreAllumettes()/j1.getGameAllumettes()) * 100)) + "%"))) * " " + "|  " + "Allumettes :  " + G + str(j2.getScoreAllumettes()) + "/" + R + str(j2.getGameAllumettes() - j2.getScoreAllumettes()) + O + " --%" + W)
        else:
            print("Allumettes :  " + G + str(j1.getScoreAllumettes()) + W + "/" + R + str(j1.getGameAllumettes() - j1.getScoreAllumettes()) + " " + O + str(round((j1.getScoreAllumettes()/j1.getGameAllumettes()) * 100)) + "%"  + W + (21 - (len(str(j1.getScoreAllumettes()) + "/" + str(j1.getGameAllumettes() - j1.getScoreAllumettes()) + " " + str(round((j1.getScoreAllumettes()/j1.getGameAllumettes()) * 100)) + "%"))) * " " + "|  " + "Allumettes :  " + G + str(j2.getScoreAllumettes()) + "/" + R + str(j2.getGameAllumettes() - j2.getScoreAllumettes()) + " " + O + str(round((j2.getScoreAllumettes()/j2.getGameAllumettes()) * 100)) + "%" + W)

        #afficher score morpion:
        if(j1.getGameMorpion() == 0 and j2.getGameMorpion() == 0):
            print("Morpion :     " + G + str(j1.getScoreMorpion()) + W + "/" + R + str(j1.getGameMorpion() - j1.getScoreMorpion()) + " " + O + "--%" + W + (21 - (len(str(j1.getScoreMorpion()) + "/" + str(j1.getGameMorpion() - j1.getScoreMorpion()) + " --%"))) * " " + "|  " + "Morpion :     " + G + str(j2.getScoreMorpion()) + W +  "/" + R + str(j2.getGameMorpion() - j2.getScoreMorpion()) + O + " --%" + W)
        elif(j1.getGameMorpion() == 0):
            print("Morpion :     " + G + str(j1.getScoreMorpion()) + W + "/" + R + str(j1.getGameMorpion() - j1.getScoreMorpion()) + " " + O + "--%" + W + (21 - (len(str(j1.getScoreMorpion()) + "/" + str(j1.getGameMorpion() - j1.getScoreMorpion()) + " --%"))) * " " + "|  " + "Morpion :     " + G + str(j2.getScoreMorpion()) + W +  "/" + R + str(j2.getGameMorpion() - j2.getScoreMorpion()) + O + " " + str(round((j2.getScoreMorpion()/j2.getGameMorpion()) * 100)) + "%" + W)
        elif(j2.getGameMorpion() == 0):
            print("Morpion :     " + G + str(j1.getScoreMorpion()) + W + "/" + R + str(j1.getGameMorpion() - j1.getScoreMorpion()) + " " + O + str(round((j1.getScoreMorpion()/j1.getGameMorpion()) * 100)) + "%"  + W + (21 - (len(str(j1.getScoreMorpion()) + "/" + str(j1.getGameMorpion() - j1.getScoreMorpion()) + " " + str(round((j1.getScoreMorpion()/j1.getGameMorpion()) * 100)) + "%"))) * " " + "|  " + "Morpion :     " + G + str(j2.getScoreMorpion()) + W +  "/" + R + str(j2.getGameMorpion() - j2.getScoreMorpion()) + O + " --%" + W)
        else:
            print("Morpion :     " + G + str(j1.getScoreMorpion()) + W + "/" + R + str(j1.getGameMorpion() - j1.getScoreMorpion()) + " " + O + str(round((j1.getScoreMorpion()/j1.getGameMorpion()) * 100)) + "%"  + W + (21 - (len(str(j1.getScoreMorpion()) + "/" + str(j1.getGameMorpion() - j1.getScoreMorpion()) + " " + str(round((j1.getScoreMorpion()/j1.getGameMorpion()) * 100)) + "%"))) * " " + "|  " + "Morpion :     " + G + str(j2.getScoreMorpion()) + W +  "/" + R + str(j2.getGameMorpion() - j2.getScoreMorpion()) + " " + O + str(round((j2.getScoreMorpion()/j2.getGameMorpion()) * 100)) + "%" + W)

        #afficher score puissance 4:
        if(j1.getGamePuissance4() == 0 and j2.getGamePuissance4() == 0):
            print("Puissance4 :  " + G + str(j1.getScorePuissance4()) + W + "/" + R + str(j1.getGamePuissance4() - j1.getScorePuissance4()) + " " + O + "--%" + W + (21 - (len(str(j1.getGamePuissance4()) + "/" + str(j1.getGamePuissance4() - j1.getScorePuissance4()) + " --%"))) * " " + "|  " + "Puissance4 :  " + G + str(j2.getScorePuissance4()) + W +  "/" + R + str(j2.getGamePuissance4() - j2.getScorePuissance4()) + O + " --%" + W)
        elif(j1.getGamePuissance4() == 0):
            print("Puissance4 :  " + G + str(j1.getScorePuissance4()) + W + "/" + R + str(j1.getGamePuissance4() - j1.getScorePuissance4()) + " " + O + "--%" + W +  (21 - (len(str(j1.getGamePuissance4()) + "/" + str(j1.getGamePuissance4() - j1.getScorePuissance4()) + " --%"))) * " " + "|  " + "Puissance4 :  " + G + str(j2.getScorePuissance4()) + W +  "/" + R + str(j2.getGamePuissance4() - j2.getScorePuissance4()) + O + " " + str(round((j2.getScorePuissance4()/j2.getGamePuissance4()) * 100)) + "%" + W)
        elif(j2.getGamePuissance4() == 0):
            print("Puissance4 :  " + G + str(j1.getScorePuissance4()) + W + "/" + R + str(j1.getGamePuissance4() - j1.getScorePuissance4()) + " " + O + str(round(j1.getScorePuissance4()/j1.getGamePuissance4() * 100)) + "%"  + W + (21 - (len(str(j1.getGamePuissance4()) + "/" + str(j1.getGamePuissance4() - j1.getScorePuissance4()) + str(round((j1.getScorePuissance4()/j1.getGamePuissance4()) * 100)) + " %"))) * " " + "|  " + "Puissance4 :  " + G + str(j2.getScorePuissance4()) + W + "/" + R + str(j2.getGamePuissance4() - j2.getScorePuissance4()) + O + " --%" + W)
        else:
            print("Puissance4 :  " + G + str(j1.getScorePuissance4()) + W + "/" + R + str(j1.getGamePuissance4() - j1.getScorePuissance4()) + " " + O + str(round(j1.getScorePuissance4()/j1.getGamePuissance4() * 100)) + "%"  + W + (21 - (len(str(j1.getGamePuissance4()) + "/" + str(j1.getGamePuissance4() - j1.getScorePuissance4()) + str(round((j1.getScorePuissance4()/j1.getGamePuissance4()) * 100)) + " %"))) * " " + "|  " + "Puissance4 :  " + G + str(j2.getScorePuissance4())  + W + "/" + R + str(j2.getGamePuissance4() - j2.getScorePuissance4()) + " " + O + str(round((j2.getScorePuissance4()/j2.getGamePuissance4()) * 100)) + "%" + W)
    ...
    if(nb_humans == 1):
        ...
        #afficher score devinette:
        if(j1.getGameDevinette() == 0): print("Devinettes :  " + G + str(j1.getScoreDevinette()) + W + "/" + R + str(j1.getGameDevinette() - j1.getScoreDevinette()) + " " + O + "100%" + W + (21 - (len(str(j1.getScoreDevinette()) + "/" + str(j1.getGameDevinette() - j1.getScoreDevinette()) + " 100%"))) * " " + "|  " + 35 * " ")
        else: print("Devinettes :  " + G + str(j1.getScoreDevinette()) + W + "/" + R + str(j1.getGameDevinette() - j1.getScoreDevinette()) + " " + O + str(round((j1.getScoreDevinette()/j1.getGameDevinette()) * 100)) + "%"  + W + (21 - (len(str(j1.getScoreDevinette()) + "/" + str(j1.getGameDevinette() - j1.getScoreDevinette()) + str(round((j1.getScoreDevinette()/j1.getGameDevinette()) * 100)) + " %"))) * " " + "|")

        #afficher score devinette:
        if(j1.getGameAllumettes() == 0): print("Allumettes :  " + G + str(j1.getScoreAllumettes()) + W + "/" + R + str(j1.getGameAllumettes() - j1.getScoreAllumettes()) + " " + O + "100%" + W + (21 - (len(str(j1.getScoreAllumettes()) + "/" + str(j1.getGameAllumettes() - j1.getScoreAllumettes()) + " 100%"))) * " " + "|  " + 35 * " ")
        else: print("Allumettes :  " + G + str(j1.getScoreAllumettes()) + W + "/" + R + str(j1.getGameAllumettes() - j1.getScoreAllumettes()) + " " + O + str(round((j1.getScoreAllumettes()/j1.getGameAllumettes()) * 100)) + "%"  + W + (21 - (len(str(j1.getScoreAllumettes()) + "/" + str(j1.getGameAllumettes() - j1.getScoreAllumettes()) + str(round((j1.getScoreAllumettes()/j1.getGameAllumettes()) * 100)) + " %"))) * " " + "|")

        #afficher score morpion:
        if(j1.getGameMorpion() == 0): print("Morpion    :  " + G + str(j1.getScoreMorpion()) + W + "/" + R + str(j1.getGameMorpion() - j1.getScoreMorpion()) + " " + O + "100%" + W + (21 - (len(str(j1.getScoreMorpion()) + "/" + str(j1.getGameMorpion() - j1.getScoreMorpion()) + " 100%"))) * " " + "|  " + 35 * " ")
        else: print("Morpion    :  " + G + str(j1.getScoreMorpion()) + W + "/" + R + str(j1.getGameMorpion() - j1.getScoreMorpion()) + " " + O + str(round((j1.getScoreMorpion()/j1.getGameMorpion()) * 100)) + "%"  + W + (21 - (len(str(j1.getScoreMorpion()) + "/" + str(j1.getGameMorpion() - j1.getScoreMorpion()) + str(round((j1.getScoreMorpion()/j1.getGameMorpion()) * 100)) + " %"))) * " " + "|")
        ...
        else: print("Puissance4 :  " + G + str(j1.getScorePuissance4()) + W + "/" + R + str(j1.getGamePuissance4() - j1.getScorePuissance4()) + " " + O + str(round(j1.getScorePuissance4()/j1.getGamePuissance4() * 100)) + "%"  + W + (21 - (len(str(j1.getScorePuissance4()) + "/" + str(j1.getGamePuissance4() - j1.getScorePuissance4()) + str(round((j1.getScorePuissance4()/j1.getGamePuissance4()) * 100)) + " %"))) * " " + "|")
        print()
...
def __afficher_scores(listJoueur : list[joueur], nom : str):
    ...
    print("Scores : " + nom)
    print("                     ")
    print(G + "Victoire" + W + " | " + R + "Défaites" + W + " | " + O +  "WinRate" + W)
    print()
    ...
    for j in listJoueur:
        if(nom == "Devinette"):
            if(j.getGameDevinette() != 0):
                ...
                playerInformations[j.getName()] = (W + j.getName() + (15 - len(j.getName())) * " " + " " + G + str(j.getScoreDevinette()) + W + "/" + R + str(j.getGameDevinette() - j.getScoreDevinette()) + W + "  " + O + str(round(j.getScoreDevinette() / j.getGameDevinette() * 100)) + "%" + W)
        if(nom == "Allumettes"):
            if(j.getGameAllumettes() != 0):
                scores[j.getName()] = j.getScoreAllumettes()
                playerInformations[j.getName()] = (W + j.getName() + (15 - len(j.getName())) * " " + " " + G + str(j.getScoreAllumettes()) + W + "/" + R + str(j.getGameAllumettes() - j.getScoreAllumettes()) + W + "  " + O + str(round(j.getScoreAllumettes() / j.getGameAllumettes() * 100)) + "%" + W)
        if(nom == "Morpion"):
            if(j.getGameMorpion() != 0):
                scores[j.getName()] = j.getScoreMorpion()
                playerInformations[j.getName()] = (W + j.getName() + (15 - len(j.getName())) * " " + " " + G + str(j.getScoreMorpion()) + W + "/" + R + str(j.getGameMorpion() - j.getScoreMorpion()) + W + "  " + O + str(round(j.getScoreMorpion() / j.getGameMorpion() * 100)) + "%" + W)
        if(nom == "Puissance 4"):
            ...
            case "2":
                ...
                while not WantToGoBack :
                    ...
                    match choice:
                        ...
                        case "4":
                            __afficher_scores(listJoueurs, "Puissance 4")
